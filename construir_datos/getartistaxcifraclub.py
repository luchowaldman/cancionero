...
#download_cifraclub_artista("los-rodriguez")

download_cifraclub_artista("los-chalchaleros")
download_cifraclub_artista("sesto-camilo")
download_cifraclub_artista("disney")
download_cifraclub_artista("the-cure")
download_cifraclub_artista("canciones-populares")
download_cifraclub_artista("creedence-clearwater-revival")
download_cifraclub_artista("britney-spears")
download_cifraclub_artista("backstreet-boys")
download_cifraclub_artista("buena-vista-social-club")
download_cifraclub_artista("blur")
download_cifraclub_artista("bon-jovi")
download_cifraclub_artista("billy-joel")
download_cifraclub_artista("bad-bunny")
download_cifraclub_artista("bruno-mars")
download_cifraclub_artista("billie-eilish")
download_cifraclub_artista("el-mato-un-policia-motorizado")
exit()

download_cifraclub_artista("estelares")
download_cifraclub_artista("enanitos-verdes")
download_cifraclub_artista("mon-laferte")
download_cifraclub_artista("trio-los-panchos")
download_cifraclub_artista("airbag")
download_cifraclub_artista("nathy-peluso")
download_cifraclub_artista("nirvana")
download_cifraclub_artista("babasonicos")
download_cifraclub_artista("the-who")
download_cifraclub_artista("abel-pintos")
download_cifraclub_artista("atahualpa-yupanqui")
download_cifraclub_artista("jorge-cafrune")
download_cifraclub_artista("horacio-guarany")
download_cifraclub_artista("julio-sosa")
download_cifraclub_artista("anibal-troilo")
download_cifraclub_artista("sumo")
download_cifraclub_artista("ariana-grande")
download_cifraclub_artista("alice-in-chains")
download_cifraclub_artista("attaque-77")
download_cifraclub_artista("alice-in-chains")
download_cifraclub_artista("alice-in-chains")
download_cifraclub_artista("depeche-mode")
download_cifraclub_artista("deep-purple")
download_cifraclub_artista("daft-punk")
download_cifraclub_artista("diego-torres-musicas")
download_cifraclub_artista("dire-straits")
download_cifraclub_artista("dread-mar-i")
