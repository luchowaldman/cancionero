...
getartista_page("enanitos-verdes")
exit()

getartista_page("estelares")
getartista_page("los-rodriguez")
getartista_page("mon-laferte")
getartista_page("trio-los-panchos")
getartista_page("airbag")
getartista_page("nathy-peluso")
getartista_page("nirvana")
getartista_page("babasonicos")
getartista_page("maria-martha-serra-lima")
getartista_page("the-who")
getartista_page("abel-pintos")
getartista_page("atahualpa-yupanqui")
getartista_page("jorge-cafrune")
getartista_page("horacio-guarany")
getartista_page("julio-sosa")
getartista_page("anibal-troilo")
getartista_page("sumo")
getartista_page("ariana-grande")
getartista_page("alice-in-chains")
getartista_page("attaque-77")
getartista_page("alice-in-chains")
getartista_page("alice-in-chains")
getartista_page("depeche-mode")
getartista_page("deep-purple")
getartista_page("daft-punk")
getartista_page("diego-torres-musicas")
getartista_page("dire-straits")
getartista_page("dread-mar-i")
getartista_page("los-chalchaleros")
getartista_page("sesto-camilo")
getartista_page("disney")
getartista_page("the-cure")
getartista_page("canciones-populares")
getartista_page("creedence-clearwater-revival")
getartista_page("britney-spears")
getartista_page("backstreet-boys")
getartista_page("buena-vista-social-club")
getartista_page("blur")
getartista_page("bon-jovi")
getartista_page("billy-joel")
getartista_page("bad-bunny")
getartista_page("bruno-mars")
getartista_page("billie-eilish")
getartista_page("el-mato-un-policia-motorizado")
getartista_page("estelares")
